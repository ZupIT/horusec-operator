...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LdapBindPassword) DeepCopyInto(out *LdapBindPassword) {
	*out = *in
	if in.SecretKeyRef != nil {
		in, out := &in.SecretKeyRef, &out.SecretKeyRef
		*out = new(v1.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LdapBindPassword.
func (in *LdapBindPassword) DeepCopy() *LdapBindPassword {
	if in == nil {
		return nil
	}
	out := new(LdapBindPassword)
	in.DeepCopyInto(out)
	return out
}
